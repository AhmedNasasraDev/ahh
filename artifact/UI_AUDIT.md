...
## Cook Mode — `/recipe/:recipeId/cook`
...
| **מפרט** | מסך 7 |
| **איך מגיעים** | מסך מתכון → «Cook Mode» · בית → «המשך» |
| **מקור נתונים** | getRecipe + mirror (offlineMirror: התקדמות) |
| **תלות Backend** | קריאה בלבד; ההתקדמות נשמרת ב-IndexedDB מקומית |
| **פעולות** | סימון שלב · ניווט בין שלבים · טיימר · יציאה |
| **States** | מסך מלא ללא טאבים · ללא שלבים |
| **בדיקות יחידה/מסך** | CookScreen.test.tsx |
| **E2E בדפדפן** | stage4 |
| **Mobile 402 / Tablet 820 / Desktop 1440** | נטען, אפס שגיאות, אפס גלישה |
| **בתצוגה** | נתוני המוצר (מתכוני הדמו) |
| **הערה** | אין h1 — הכיתוב הראשי הוא מספר השלב |
